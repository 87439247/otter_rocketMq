...
import com.alibaba.otter.node.etl.load.loader.rocketmq.RocketMQLoadAction;
            ...
            futures.add(completionService.submit(new Callable<DbLoadContext>() {
                ...
                public DbLoadContext call() throws Exception {
                    try {
                        ...
                        RocketMQLoadAction rocketMQLoadAction = (RocketMQLoadAction) beanFactory.getBean("rocketMQLoadAction",
                                RocketMQLoadAction.class);
                        return rocketMQLoadAction.load(rowBatch, controller);
                    } finally {
                        MDC.remove(OtterConstants.splitPipelineLogFileKey);
                    }
                }
